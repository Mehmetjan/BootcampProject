...
public class ShowWeather extends CommonAPI {
    @FindBy (how = How.XPATH,using = "//*[@class='icon sprite-icon weather-icon icon-weather-12 w24']")
    ...
    public void weatherForcast(){
        ...
        weath.moveToElement(driver.findElement(By.xpath("//*[@class='icon sprite-icon weather-icon icon-weather-12 w24']"))).perform();
    }
}
